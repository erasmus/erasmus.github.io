...
export interface Edu { institution: string; qualification: string; years: string; icon?: string; logo?: string }
...
export const CV: Cv = {
  ...
  education: [
    { institution: 'University of Oxford', icon: 'University_of_Oxford.svg', logo: 'University_of_Oxford_full.svg', qualification: 'MSc, Social Science of the Internet', years: '2011–2012' },
    { institution: 'Goldsmiths College, University of London', icon: 'Goldsmith_University-logo.svg', logo: 'Goldsmith_University-logo_full.svg', qualification: 'BA, Media & Communications', years: '2008–2011' },
    { institution: 'London School of Economics', icon: 'LSE_Logo.svg', logo: 'London_school_of_economics_logo_full.svg', qualification: 'Diploma, Managerial Accounting and Financial Control', years: '2010' },
